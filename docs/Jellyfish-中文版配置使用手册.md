...
本机正式数据库已迁移到 Alembic revision `b9e4c7a2d106`。迁移前备份位于 `E:\JellyfishBackups\script-import-20260904-105743`，其中 Git bundle 和压缩 SQL 均已校验；该目录是恢复副本，不是第二套在线数据库。迁移后项目、章节、模型、供应商、任务和文件数量与迁移前一致。
